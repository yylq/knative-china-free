...
COMPONENTS=(
  ["tekton-pipeline.yaml"]="config"
)
readonly COMPONENTS

declare -A RELEASES
RELEASES=(
  ["release.yaml"]="tekton-pipeline.yaml"
)
readonly RELEASES
export TAG="v0.19.0"
export KO_DOCKER_REPO="cdn-cn-north-1.jcr.service.jdcloud.com/tekton"
